...
function lingonberry_load_javascript_files() {
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'lingonberry_mediaelement', get_template_directory_uri().'/js/mediaelement-and-player.min.js', array('jquery'), '', true  );
...
function cd_meta_box_cb( $post ) {
	...
	wp_nonce_field( 'lingonberry_meta_box', 'meta_box_nonce' );
	?>
		<p>
...
function cd_meta_box_save( $post_id ) {
	...
	if( !isset( $_POST['lingonberry_meta_box'] ) || !wp_verify_nonce( $_POST['meta_box_nonce'], 'lingonberry_meta_box' ) ) return;
